...
driver.find_element(By.XPATH, "(//input[@placeholder='Type for hints...'])[2]").send_keys("202412060000007")
time.sleep(4)

driver.find_element(By.XPATH, "(//div[contains(text(),'-- Select --')])[1]").click()
time.sleep(4)

driver.find_element(By.XPATH, "//span[text()='Accommodation']").click()
time.sleep(10)

driver.find_element(By.XPATH, "(//div[@class='oxd-select-text-input'])[2]").click()
time.sleep(4)
driver.find_element(By.XPATH, "//span[text()='Paid']").click()
time.sleep(4)
...
driver.find_element(By.XPATH, "(//button[normalize-space()='View Details'])[1]").click()
time.sleep(5)
