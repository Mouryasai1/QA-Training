...
# driver.find_element(By.CSS_SELECTOR, "[placeholder='Type for hints...']").send_keys("FNCypressTest Jacke1 LNCypressTest")
# time.sleep(2)
#
#
...
driver.find_element(By.XPATH, "(//button[normalize-space()='Assign Claim'])[1]").click()
